...
| `fox_qq_ocr_image` | 识别图片文字(QQ 自带 OCR)。传消息 ID 识别其中的图片,或直接传图片 URL |
| `fox_qq_voice_to_text` | 语音转文字(QQ 自带 STT)。传含语音消息的 ID,需 NapCat 2026-05 后版本 |
